...
const Navbar = ({ activeSection } : NavbarProps) => {
  ...
  return (
    <header className='flex justify-center items-center animate-dropIn fixed top-4 z-[99] w-full px-10'>
      <div className='relative flex justify-center items-center pl-6 pr-16 md:px-28 lg:px-48 py-4 bg-light dark:bg-dark bg-opacity-80 rounded-5xl border-[1px] border-[#ccc] dark:border-[#555]  backdrop-blur shadow-lg'>
