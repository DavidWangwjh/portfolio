...
export const PROJECTS: PROJECT[] = [
  {
    ...
    // duration: 'Apr 2023 – Dec 2023',
    // location: 'San Diego, CA',
    description: 'A social networking and event management app designed for college students, aggregating data from platforms like Instagram and Discord. It serves as a central hub where students can discover and host events, fostering campus connections and engagement. The app currently has a growing user base of 2,000+ students.',
  ...
  },
  {
    ...
    // location: 'Remote',
    description: "An Android mood-tracking app integrated with Natural Language Processing (NLP) to analyze user journals, offering personalized feedback based on their current mood. The app tracks mood patterns over time, helping users gain self-awareness of emotional triggers and cultivate a healthy mindset. MoodGuru was showcased as a top 10 finalist at CodePath's 2022 National Demo Day.",
  ...
  },
  {
    ...
    // location: 'San Diego, CA',
    description: 'A personalized budget planner website using local storage. The entire project adheres to Agile methodologies such as regular stand-ups and sprint sessions, ADR and retrospectives, and CI/CD pipelines.',
